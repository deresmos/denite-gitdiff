...
class Source(GitDiffBase):
    _HIGHLIGHT_SYNTAX = [
        {"name": "gitDiffAdd", "link": "DiffAdd", "re": r"A:"},
        {"name": "gitDiffModify", "link": "DiffChange", "re": r"M:"},
        {"name": "gitDiffDelete", "link": "DiffDelete", "re": r"D:"},
    ]
    ...
    def gather_candidates(self, context):
        ...
        candidates = [
            ...
            for r in res
            if filter_val in r[type_i] + " " + r[path_i]
        ]
